...
def main():
    """Train either NLP, computer vision or speech recognition models"""
    # Hyperparameters
    layers = 1
    layer_units = 1000
    epochs = 7
    ...
    # Dataset : "nlp", "computer_vision" or "speech_recognition"
    ...
    #trained_model.save('models/model_%s_a1.h5' % dataset)
